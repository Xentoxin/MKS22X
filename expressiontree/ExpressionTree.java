public class ExpressionTree {
	...
	public double evaluate() {
		...
		if (isValue()) {
			...
			if (getOp() == '-') {
				x = getLeft().evaluate() - getRight().evaluate();
			}
			if (getOp() == '+') {
				x = getLeft().evaluate() + getRight().evaluate();
			}
	...
	public String toString() {
		...
		if (isValue()) {
			...
			str += "(" + getLeft().toString() + " " + getOp() + " " + getRight().toString() + ")";
		}
		return str;
	}
	...
	public String toStringPostfix() {
		...
		if (isValue()) {
			...
			str += "(" + getLeft().toStringPostfix() + " " + getRight().toStringPostfix() + " " + getOp() + ")";
		}
		return str;
	}
	...
	public String toStringPrefix() {
		...
		if (isValue()) {
			...
			str += "(" + getOp() + " " + getLeft().toStringPrefix() + " " + getRight().toStringPrefix() + ")";
		}
		return str;
	}
